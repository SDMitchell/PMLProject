...
Given the PCA components produced, this doesn't look like a winning algorithm. The two main components only explain 30-ish percent of the variability in the data and there is some massive overlap in three of the clusters. This calls for more extensive analysis.
...
Well, `r as.integer(quizSuccessRF * 100.0)`% is pretty decent as well.

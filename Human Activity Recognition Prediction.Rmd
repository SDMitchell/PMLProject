...
The summary statistics are also captured in their own set of features which we can safely ignore; they seem to be any feature starting with any of the following prefixes as well as anything to do with user name, trial or timestamps:
...
```
	...
	Do again with cross=10? Then we can talk about cross validation
